...
class Give_Stripe_Log_Table extends WP_List_Table {
	...
	public function get_columns() {
		$columns = array(
			'ID'      => __( 'Log ID', 'give-stripe' ),
			'error'   => __( 'Error', 'give-stripe' ),
			'date'    => __( 'Date', 'give-stripe' ),
			'details' => __( 'Process Details', 'give-stripe' ),
		);
	...
	public function column_details( $item ) {
		echo wp_kses_post( Give()->tooltips->render_link( array(
			'label'       => __( 'View Stripe Log', 'give-stripe' ),
