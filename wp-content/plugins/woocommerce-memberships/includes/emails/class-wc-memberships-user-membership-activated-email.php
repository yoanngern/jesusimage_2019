...
class WC_Memberships_User_Membership_Activated_Email extends \WC_Memberships_User_Membership_Email {
	...
	public function __construct() {
		...
		$this->id    = __CLASS__;
		$this->title = __( 'Membership activated', 'woocommerce-memberships' );

		$description  =  __( 'Membership activated emails are sent to members when a delayed membership is activated.', 'woocommerce-memberships' );
